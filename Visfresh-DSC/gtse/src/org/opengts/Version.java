...
public class Version
{
    ...
    private static final String VERSION = "2.6.0-B83"; // 2.5.9-B59, 2.5.8-B70 
    ...
    private static final long PACKAGE_TIMESTAMP = 1442858440L;
    public static final String SERVICE_ACCOUNT_ID = "freshyes";
