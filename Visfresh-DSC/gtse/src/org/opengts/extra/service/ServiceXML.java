...
public interface ServiceXML
{
    ...
    // <GTSRequest command="report">
    //    <Authorization account="account" user="user" password="password"/>
    //    <Report name="EventSummary" reportJobID="RJID">
    //       <DeviceGroup>mydevice</DeviceGroup>
    ...
    // </GTSRequest>
    //
    // <!-- get reports by ReportJob -->
    // <GTSRequest command="report">
    //    <Authorization account="account" user="user" password="password"/>
    //    <ReportJob reportGroupTag="CRON_TAG"/>
    // </GTSRequest>
    ...
    // <GTSRequest command="custom">
    //    <Authorization account="account" user="user" password="password"/>
    //    <CustomCommand name="test" arg="submit"/>
    // </GTSRequest>

    // ------------------------------------------------------------------------
    // ------------------------------------------------------------------------

    public static final String TAG_GTSRequest               = "GTSRequest";     // ServiceRequest.SRTAG_GTSRequest
    public static final String TAG_GTSResponse              = "GTSResponse";    // ServiceRequest.SRTAG_GTSResponse
    public static final String TAG_Authorization            = "Authorization";  // ServiceRequest.SRTAG_Authorization
    ...
    public static final String TAG_ReportJob                = "ReportJob";
    public static final String TAG_IncludeColumns           = "IncludeColumns";
  ...
  //public static final String TAG_HTML                     = "HTML";
    ...
    public static final String TAG_CustomCommand            = "CustomCommand";

    // ----------------

    public static final String ATTR_account                 = "account";        // ServiceRequest.SRATTR_account
    public static final String ATTR_user                    = "user";           // ServiceRequest.SRATTR_user
    public static final String ATTR_password                = "password";       // ServiceRequest.SRATTR_password
  //public static final String ATTR_auth                    = "auth";           // ServiceRequest.SRATTR_auth

    public static final String ATTR_name                    = "name";
    public static final String ATTR_option                  = "option";
    public static final String ATTR_reportJobID             = "reportJobID";
    public static final String ATTR_reportGroupTag          = "reportGroupTag";
    ...
    public static final String ATTR_limit                   = "limit";          // [2.6.0-B57] "dbget"
    public static final String ATTR_ascending               = "ascending";      // [2.6.0-B57] "dbget"
    public static final String ATTR_orderBy                 = "orderBy";        // [2.6.0-B57] "dbget"
  //public static final String ATTR_where                   = "where";          // [2.6.0-B57] "dbget" (not yet supported)
