    ...
    extends AccountRecord<SystemAudit>
{
        ...
        )
    {
        ...
        if (StringTools.isBlank(accountID)) { accountID = DBRecord.GetCurrentAccount(); }
        if (StringTools.isBlank(userID)   ) { userID    = DBRecord.GetCurrentUser();    }
        ...
        extends AccountKey<SystemAudit>
    {
        ...
        public Key(String accountID, long auditTime, int auditCode) {
            super.setKeyValue(FLD_accountID, accountID);
            super.setKeyValue(FLD_auditTime, auditTime);
            super.setKeyValue(FLD_auditCode, auditCode);
        }
