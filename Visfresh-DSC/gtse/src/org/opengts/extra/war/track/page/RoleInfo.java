    ...
    implements Constants
{
        ...
        throws IOException
    {
        ...
        if (updateRole) {
            ...
            if (selRole == null) {
                // should not occur
                m = i18n.getString("RoleInfo.unableToUpdate","Unable to update Role, ID not found"); // UserErrMsg
                error = true;
                updateRole = false;
            }
        } else
        if (selectRole) {
            ...
            if (SubmitMatch(submitDelete,i18n.getString("RoleInfo.delete","Delete"))) {
                ...
                if (selRole == null) {
                    m = i18n.getString("RoleInfo.pleaseSelectRole","Please select a Role"); // UserErrMsg
                    error = true;
        ...
        if (deleteRole) {
            if (selRole == null) {
                ...
                try {
                    ...
                    m = i18n.getString("RoleInfo.errorDelete","Internal error deleting Role"); // UserErrMsg
                    error = true;
                }
            }
            listRoles = true;
        ...
        if (newRole) {
            ...
            for (int u = 0; u < roleList.length; u++) {
                if (newRoleID.equalsIgnoreCase(roleList[u])) {
                    m = i18n.getString("RoleInfo.alreadyExists","This role already exists"); // UserErrMsg
                    error = true;
                    createRoleOK = false;
                    break;
                }
            ...
            if (createRoleOK) {
                try {
                    ...
                    m = i18n.getString("RoleInfo.createdRole","New role has been created"); // UserErrMsg
                } catch (DBException dbe) {
                    Print.logException("Creating Role", dbe);
                    m = i18n.getString("RoleInfo.errorCreate","Internal error creating Role"); // UserErrMsg
                    error = true;
                }
            }
            listRoles = true;
            ...
            try {
                if (selRole != null) {
                        ...
                        for (int i = 0; i < aclKeys.length; i++) {
                            ...
                            if (aclVal.equalsIgnoreCase(i18n.getString("RoleInfo.default","Default"))) {
                                try {
                                    ...
                                    m = i18n.getString("RoleInfo.errorDeleteAcl","Internal error deleting RoleAcl"); // UserErrMsg
                                    error = true;
                                }
                            } else {
                                ...
                                try {
                                    ...
                                    m = i18n.getString("RoleInfo.errorUpdate","Internal error updating Role"); // UserErrMsg
                                    error = true;
                                }
                            }
                        }
                    ...
                    if (saveOK) {
                        ...
                        m = i18n.getString("RoleInfo.roleUpdated","Role information updated"); // UserErrMsg
                    } else {
                    ...
                    m = i18n.getString("RoleInfo.noRoles","There are currently no defined roles for this account."); // UserErrMsg
                }
                //return;
            } catch (Throwable t) {
            ...
            public void write(PrintWriter out) throws IOException {
              ...
              //String selectRoleJS = "javascript:dinfoSelectRole()";
                ...
                if (_listRoles) {
                    ...
                    out.write("<form name='"+FORM_ROLE_SELECT+"' method='post' action='"+selectURL+"' target='_self'>"); // target='_top'
                    ...
                    out.write("<form name='"+FORM_ROLE_NEW+"' method='post' action='"+newURL+"' target='_self'>"); // target='_top'
                    ...
                    /* start of form */
                    out.write("<form name='"+FORM_ROLE_EDIT+"' method='post' action='"+editURL+"' target='_self'>\n"); // target='_top'
