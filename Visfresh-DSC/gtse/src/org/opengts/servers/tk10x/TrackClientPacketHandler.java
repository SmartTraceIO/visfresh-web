    ...
    extends AbstractClientPacketHandler
{
    ...
    **/
    private byte[] parseInsertRecord_TK103_2(String s) // handleCommon
    {
        ...
        if (fld[4].equals("L")) {
            ...
            fuelLevel    = (fld.length > 16)? StringTools.parseDouble(fld[16],-1.0) : -1.0;
            fuelLevel2   = (fld.length > 17)? StringTools.parseDouble(fld[17],-1.0) : -1.0;
    ...
    **/
    private byte[] parseInsertRecord_TKnano_2(byte pktBytes[]) // handleCommon
    {
        ...
        double speedKPH   = (double)(speedDir / 1000) * KILOMETERS_PER_KNOT;
