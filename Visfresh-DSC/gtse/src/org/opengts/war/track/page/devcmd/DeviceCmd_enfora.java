    ...
    implements DeviceCmdHandler
{
    ...
    private static String GetResponseMessage(RTProperties resp, I18N i18n)
    {
        if (resp == null) {
            ...
            if ((rc == null) || rc.isSuccess()) {
                ...
                return i18n.getString("DeviceCmd_enfora.commandError" ,"Unable to queue command: {0}", m);
            }
        }
    }
    ...
    public String handleDeviceCommands(RequestProperties reqState, Device selDev)
    {
        ...
        /* unknown command */
        return i18n.getString("DeviceCmd_enfora.unknownCommand","No command selected");
