...
## Lists ##
List items is short representations of base entities, like as [Alert Profile](#alert-profile), [Location](#location), etc. Some of fields can be get from corresponding base entity and some can be synthetic fields.  
1. [Shipment Template list item](#shipment-template-list-item) 
...
1. pageIndex - number of page  
2. pageSize - size of page  
Returns array of [Shipment Template List item](#shipment-template-list-item)  
...
```  
see [Ordinary Alert Object](#alert), [Temperature Alert Object](#temperature-alert), [Arrival Object](#arrival)
### Alert ###
```json
{
	"id": 14,
