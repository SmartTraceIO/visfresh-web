...
public class DCServerFactory
{
    ...
    **/
    ...
    public static final String  DATATEST_NAME                   = "datatest";       // [3x001]
    public static final String  SANAV_NAME                      = "sanav";          // [3x220] (3x420) GC-101, GX-101
    public static final String  CUSTOMPARSE_NAME                = "customparse";    // [3x225]
    public static final String  FALCOM_NAME                     = "falcom";         // [3x230]
    public static final String  AGORABEE_NAME                   = "agorabee";       // [3x232]
    public static final String  KENWOOD_NAME                    = "kenwood";        // [3x237]
  ...
  //public static final String  TAIP_NAME                       = "taip";           // [3x275] 
    ...
    public static final String  GALILEOSKY_NAME                 = "galileosky";     // [3x350] GalileoSky
    ...
    public static final String  T8806_NAME                      = "t8806";          // [3x377] 
    public static final String  T880X_NAME                      = "t880x";          // [3x378] 
    public static final String  K611_NAME                       = "k611";           // [3x380] 
    public static final String  GT68_NAME                       = "gt68";           // [3x383] 
    public static final String  EVIEW_NAME                      = "eview";          // [3x385] EView EV-07
    public static final String  EASYTRACK_NAME                  = "easytrack";      // [3x387] KingSword EasyTrack
    ...
    public static final String  TLT2H_NAME                      = "tlt2h";          // [3x463] Gotop TLT-2H
    ...
    public static final String  QGL300_NAME                     = "qgl300";         // [3x494] (31494) Queclink GL300
    ...
    public static final String  SCATLITE_NAME                   = "scatlite";       // [3x502] (31502) SIMCom Prime AT-Lite
    public static final String  SCVL2000_NAME                   = "scvl2000";       // [3x503] (31503) SIMCom VL2000
    public static final String  QGT300_NAME                     = "qgt300";         // [3x504] (31504) Queclink GT300
    public static final String  QGT500_NAME                     = "qgt500";         // [3x506] (31506) Queclink GT500
    public static final String  QGL500_NAME                     = "qgl500";         // [3x508] (31508) Queclink GL500
    public static final String  QGV500_NAME                     = "qgv500";         // [3x509] (31509) Queclink GV500
    ...
    public static final String  JT600_NAME                      = "jt600";          // [3x550] JoinTech JT600
    public static final String  JTGP4000_NAME                   = "jtgp4000";       // [3x552] JoinTech GP4000
    public static final String  PGT3000_NAME                    = "pgt3000";        // [3x570] Portman GT3000
    public static final String  NTSLIM_NAME                     = "ntslim";         // [3x576] Navtrack NT-Slim (custom)
    public static final String  NT1000_NAME                     = "nt1000";         // [3x578] Navtrack NT1000 (custom)
    public static final String  POINTER_NAME                    = "pointer";        // [3x580] Pointer
    public static final String  CITGT02_NAME                    = "citgt02";        // [3x590] GT02
    public static final String  CITGT06_NAME                    = "citgt06";        // [3x593] GT06
    public static final String  TOUCAN_NAME                     = "toucan";         // [3x600] Nimblewireless Toucan
    public static final String  RUPTELA_NAME                    = "ruptela";        // [3x608] Ruptela
    public static final String  MTEPS_NAME                      = "mteps";          // [3x610] Microtracker EPS5/8
    public static final String  MSP340_NAME                     = "msp340";         // [3x612] MSP340/PetTracker
    public static final String  GOS9600_NAME                    = "gos9600";        // [3x620] GoSafe 9600
    public static final String  GOSAFE_NAME                     = "gosafe";         // [3x621] GoSafe
    public static final String  GOS777_NAME                     = "gos777";         // [3x623] GoSafe GOS-777
    public static final String  GOS9800_NAME                    = "gos9800";        // [29625] GoSafe GOS-9800 [port < 32K]
    public static final String  ULBOTECH_NAME                   = "ulbotech";       // [3x628] ULBOtech (same proto as gos777)
    public static final String  SENDUM_NAME                     = "sendum";         // [3x640] Sendum PT300
    public static final String  CLEARCOMM_NAME                  = "clearcomm";      // [3x650] ClearComm
    public static final String  MAESTRO_NAME                    = "maestro";        // [3x660] Maestro
    public static final String  JSCRT803_NAME                   = "jscrt803";       // [3x670] JSCRT803
    public static final String  IONIT_NAME                      = "ionit";          // [3x673] ION IT Global
    public static final String  TRIMTRAC_NAME                   = "trimtrac";       // [3x680] TrimTrac Pro
    public static final String  SIERRA_NAME                     = "sierra";         // [3x684] Sierra Wireless
    public static final String  CRADLEPOINT_NAME                = "cradlepoint";    // [3x687] CradlePoint IBR600/IBR650
    public static final String  XIRGO_NAME                      = "xirgo";          // [3x690] Xirgo

    public static final String  SQUARELL_NAME                   = "squarell";       // [3x710] Squarell
    public static final String  TRACUSA_NAME                    = "tracusa";        // [3x715] LBTelematics TracUSA
    ...
    public static final String  IRIDIUMDCS_NAME                 = "iridiumdcs";     // [xxxxx]

    /* new servlet-based DCS */
    // (these do support 'dcserver_xxxx.xml' file)
    public static final String  AXONN_NAME                      = "axonn";          // Servlet
    public static final String  FA888_NAME                      = "fa888";          // Servlet

    /* old servlet-based DCS */
    // (these do not support 'dcserver_xxxx.xml' file)
    public static final String  GSSPOT_NAME                     = "w-gsspot";       // Servlet
    public static final String  GEOFORCE_NAME                   = "w-geoforce";     // Servlet
    public static final String  PARATEL_NAME                    = "w-paratel";      // Servlet
    public static final String  DELORME_NAME                    = "w-delorme";      // Servlet
    public static final String  COVIXON_NAME                    = "w-covixon";      // Servlet
    ...
    public static final String  RGPROXY_NAME                    = "rgproxy";        // [35001]
