...
public class Constants
{
    ...
    public static final String  VERSION                        = "0.2.18"; // 2.5.4-B30
    ...
    /* properties */
    public static final String  CFG_tcpPacketLengthEndOfStream = DEVICE_CODE + ".tcpPacketLengthEndOfStream";
