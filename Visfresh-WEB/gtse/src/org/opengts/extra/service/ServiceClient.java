    ...
    implements ServiceXML
{
    ...
    private static final String ARG_AUTHKEY[]   = new String[] { "authKey"  , "k"      , "SERVICE_AUTHKEY" };
  //private static final String ARG_LIST_DEV[]  = new String[] { "listdev"          };
    ...
    private static void usage_exit(int exitCode)
    {
        ...
        Print.sysPrintln("  Web-service client tool.");
        Print.sysPrintln("");
    ...
    public static int cron(String argv[])
    {
        ...
        final String authKey = RTConfig.getString(ARG_AUTHKEY , ""); // "auth");
        ...
        try {
            ...
            servReq.setAuthorization(acctID, userID, passwd); // cron
        ...
        /* report job */
        if (RTConfig.hasProperty(ARG_REPORTJOB)) {
            String cronTag = RTConfig.getString(ARG_REPORTJOB,"");
            // TODO:
        }
    ...
    public static void main(String args[])
    {
        ...
        GTSServiceRequest servReq = null;
        try {
            servReq = new GTSServiceRequest(urlStr); // command-line
            servReq.setAuthorization(acctID, userID, passwd); // command-line
        } catch (MalformedURLException mue) {
            Print.logException("Error", mue);
            System.exit(99);
        }
        ...
        if (command.equalsIgnoreCase("reportJob")) {
            try {
                String rtpGrpTag = RTConfig.getString(ARG_MISC_ARG,"");
