...
public class Shape
{
    ...
    private static GeoPolygon[] CreateGeoPolygon(Point shapePoints[], int shapeParts[])
    {
        ...
        if (polyOuter.size() == 1) {
            ...
            for (GeoPolygon inner : polyInner) {
                ...
                if (gp != null) {
                    Print.logWarn("No outer polygon found for inner polygon");
                }
            }
        }
    ...
    **/
    ...
    /**
    *** Gets the shape type (SHAPETYPE_POLYGON, SHAPETYPE_POINT, etc)
    **/
    ...
    /**
    *** Returns true if this Shape instance has a defined BoundingBox
    **/
    public boolean hasBoundingBox()
    {
        return (this.shapeBB != null)? true : false;
    }

    /** 
    *** Gets this Shapes BoundingBox
    **/
    ...
    /**
    *** Gets this Shapes points as an array of Point objects.
    **/
    ...
    **/
    ...
    /**
    *** Gets the M-range of this Shape
    **/
    ...
    /**
    *** Gets the Z-range of this Shape
    **/
    ...
    /**
    *** Gets an array of GeoPolygons for this shape
    **/
    ...
    /**
    *** Converts this Shape to a byte array
    **/
    ...
    /**
    *** Converts this Shape to a Payload instance
    **/
    ...
    /**
    *** Gets the length of this Shape in number of bytes
    **/
    ...
    /**
    *** Writes this Shape to the specified Payload instance
    **/
    ...
    **/
    public String toString(StringBuffer sb) 
    {
        ...
        // -- Type
        sb.append("  Shape      : " + GetShapeTypeDescription(this.shapeType) + "["+this.shapeType+"]").append("\n");
        // -- Record Index
        ...
        if (this.shapePolygon != null) {
            for (int i = 0; i < this.shapePolygon.length; i++) {
                boolean hasNeg = this.shapePolygon[i].hasNegativeRings();
                String  strCnt = this.shapePolygon[i].getPointCountString();
                sb.append("  ShapePoly count ["+i+"]: " + strCnt);
                if (hasNeg) { sb.append(" (neg) "); }
                sb.append("\n");
            }
        } else
