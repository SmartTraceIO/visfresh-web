    ...
    public DBDataIterator getBodyDataIterator()
    {
        ...
        DBRecordHandler<SystemAudit> rcdHandler = new DBRecordHandler<SystemAudit>() {
            public int handleDBRecord(SystemAudit rcd) throws DBException {
                ...
                fd.setValue(FieldLayout.DATA_DESCRIPTION     , sa.getDescription());
                fd.setValue(FieldLayout.DATA_NOTES           , sa.getNotes());
                fd.setValue(FieldLayout.DATA_PRIVATE_LABEL   , sa.getPrivateLabelName());
