                ...
                if (_listZones) {
                    ...
                    */
                    ...
                    for (int z = 0; z < pointCount; z++) {
                        ...
                        String latCSS = CSS_LATLON_INPUT;
                        String lonCSS = CSS_LATLON_INPUT;
                        out.println(Form_TextField(MapProviderAdapter.ID_ZONE_LATITUDE (z), PARM_ZONE_LATITUDE (z), _editZone, latStr, null/*onclick*/,  9,  9, latCSS));
                        out.println(Form_TextField(MapProviderAdapter.ID_ZONE_LONGITUDE(z), PARM_ZONE_LONGITUDE(z), _editZone, lonStr, null/*onclick*/, 10, 10, lonCSS));
                    ...
                    if (_editZone && mapSupportsCorridors) {
                        ...
                        if (privLabel.getBooleanProperty(PrivateLabel.PROP_CorridorInfo_enableGeocode,false)) {
                            ...
                            String dftCountryCode = privLabel.getStringProperty(PrivateLabel.PROP_CorridorInfo_enableGeocode_country,"US");
                            String i18nZipBtn = "";
