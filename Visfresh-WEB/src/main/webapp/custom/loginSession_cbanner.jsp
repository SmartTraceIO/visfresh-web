...
<gts:var ifTrue="isLoggedIn" andTrue="login.hideBannerAfterLogin">
  ...
  <td align="center">
     ...
     <table width="<gts:track section='banner.image.width' default='860'/>" border="0" cellpadding="0" cellspacing="0">
     <tbody>
     <tr>
    ...
    <tr>
      ...
      <td nowrap style="padding-bottom: 2px;">
         <span style="font-size: 7pt; font-style: oblique; color: #888888;">
             <gts:var ifTrue="login.showGTSVersion">${version}</gts:var>
         </span>&nbsp;&nbsp;
         <gts:var ifTrue="login.showPiLink"><a style="font-size: 11pt; text-decoration: none;" href="${login.piLink=http://www.geotelematic.com}" target="_blank">&pi;</a>&nbsp;</gts:var>
      </td>
    </tr>
    </tbody>
    </table>
