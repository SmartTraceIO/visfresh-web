...
public class ReportsControllerTest extends AbstractRestServiceTest {
    ...
    @Test
    public void testGetPerformanceReportByMonth() throws IOException, RestServiceException {
        createShipment();
        final Map<String, String> params = new HashMap<>();
        params.put("month", "2016-07");
    ...
    @Test
    public void testGetPerformanceReportByWeek() throws IOException, RestServiceException {
        createShipment();
        final Map<String, String> params = new HashMap<>();
        params.put("month", "2016-07-01");
        params.put("period", "week");
    ...
    @Test
    public void testGetPerformanceReportByLocation() throws IOException, RestServiceException {
        final Shipment s = createShipment();
        final Map<String, String> params = new HashMap<>();
        params.put("month", "2016-07-01");
        params.put("location", s.getShippedTo().getId().toString());
    ...
    @Test
    public void testGetPerformanceReportQuarter() throws IOException, RestServiceException {
        createShipment();
        final Map<String, String> params = new HashMap<>();
        params.put("month", "2016-07-01");
